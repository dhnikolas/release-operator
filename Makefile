...
# salt.x5.ru/release-operator-bundle:$VERSION and salt.x5.ru/release-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= salt.x5.ru/release-operator
...
IMG ?= dhnikolas/release-operator
