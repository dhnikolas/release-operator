...
import (
	...
	"github.com/dhnikolas/release-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "fd59eb75.salt.x5.ru",
		Client: client.Options{
			Cache: &client.CacheOptions{DisableFor: []client.Object{
				&releasev1alpha1.Build{},
				&releasev1alpha1.Merge{},
				&releasev1alpha1.NativeMergeRequest{},
			}},
		},
	...
	if err = (&controllers.NativeMergeRequestReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		App:    a,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "NativeMergeRequest")
		os.Exit(1)
	}
